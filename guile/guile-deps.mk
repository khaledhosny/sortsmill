...
sortsmill/fonts/name-table.go: sortsmill/dynlink.go sortsmill/fonts/opentype-io.go sortsmill/strings/ietf-language-tags.go sortsmill/postscript.go sortsmill/mac-encodings.go sortsmill/kwargs.go sortsmill/notices.go sortsmill/i18n.go sortsmill/fontforge-api.go
...
sortsmill/math/brentroot.go: sortsmill/dynlink.go
...
sortsmill/math/matrices/linalg.go: sortsmill/math/matrices/base.go sortsmill/math/matrices/arithmetic.go sortsmill/math/gsl/matrices.go sortsmill/arrays.go sortsmill/i18n.go sortsmill/kwargs.go
...
sortsmill/math/polyspline/inversion.go: sortsmill/math/polyspline/add.go sortsmill/math/polyspline/eval.go sortsmill/math/polyspline/reduce.go sortsmill/math/polyspline/roots.go sortsmill/math/matrices.go sortsmill/kwargs.go sortsmill/i18n.go
...
sortsmill/options.go: sortsmill/dynlink.go sortsmill/kwargs.go sortsmill/pkg-info.go sortsmill/api-syntax.go sortsmill/strings.go sortsmill/argv.go
...
sortsmill/svg/path-data.go: sortsmill/kwargs.go sortsmill/math/polyspline.go sortsmill/math/matrices.go sortsmill/math/geometry.go sortsmill/nearness.go
...
sortsmill.go: sortsmill/argv.go sortsmill/arrays.go sortsmill/containers.go sortsmill/editor.go sortsmill/fonts.go sortsmill/i18n.go sortsmill/iconv.go sortsmill/kwargs.go sortsmill/mac-encodings.go sortsmill/math.go sortsmill/nearness.go sortsmill/notices.go sortsmill/postscript.go sortsmill/pkg-info.go sortsmill/strings.go sortsmill/svg.go
...
sortsmill/math.go: sortsmill/math/brentroot.go sortsmill/math/functions.go sortsmill/math/geometry.go sortsmill/math/gsl.go sortsmill/math/multivariate-polynomials.go sortsmill/math/matrices.go sortsmill/math/polyspline.go
