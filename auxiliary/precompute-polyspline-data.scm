...
(format #t "VISIBLE unsigned int\n")
(format #t "polyspline_degree_max (void)\n")
(format #t "{\n")
(format #t "  return MAX_POLYSPLINE_DEGREE;\n")
(format #t "}\n\n")
...
(format #t ";\n\n")
(format #t "VISIBLE const double *\n")
(format #t "fl_binomial_coefficients (unsigned int degree)\n")
(format #t "{\n")
(format #t "  return ((degree <= MAX_POLYSPLINE_DEGREE) ?\n")
...
(format #t ";\n\n")
(format #t "VISIBLE const double *\n")
(format #t "fl_binomial_coefficients_altsigns (unsigned int degree)\n")
(format #t "{\n")
(format #t "  return ((degree <= MAX_POLYSPLINE_DEGREE) ?\n")
...
(format #t ";\n\n")
(format #t "VISIBLE const double *\n")
(format #t "fl_sbern_basis_in_mono (unsigned int degree)\n")
(format #t "{\n")
(format #t "  return ((degree <= MAX_POLYSPLINE_DEGREE) ?\n")
...
(format #t ";\n\n")
(format #t "VISIBLE const double *\n")
(format #t "fl_mono_basis_in_sbern (unsigned int degree)\n")
(format #t "{\n")
(format #t "  return ((degree <= MAX_POLYSPLINE_DEGREE) ?\n")
...
(format #t ";\n\n")
(format #t "VISIBLE const double *\n")
(format #t "fl_sbern_basis_in_spower (unsigned int degree)\n")
(format #t "{\n")
(format #t "  return ((degree <= MAX_POLYSPLINE_DEGREE) ?\n")
...
(format #t ";\n\n")
(format #t "VISIBLE const double *\n")
(format #t "fl_spower_basis_in_sbern (unsigned int degree)\n")
(format #t "{\n")
(format #t "  return ((degree <= MAX_POLYSPLINE_DEGREE) ?\n")
