...
(let ((instructions (read-instructions-from-program-input)))
   (display-fortran-type-decl (make-fortran-type-decl-node "bloo" '("a" "b")))
   (display-fortran-var-decl (make-fortran-var-decl-node
                                "varrrr"
                                (make-fortran-type-node "type" "bloo" #f)))
   (display-fortran-overload (make-fortran-overload-node "foo" "bar"))
   )
...
;;   (format #t "\n")
;;   (format #t "module sortsmillff_fontforge_api\n")
...
;;   (format #t "end module sortsmillff_fontforge_api\n")
;;   )
