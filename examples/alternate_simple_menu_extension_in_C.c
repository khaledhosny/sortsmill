 ...
 * this:
 *
 *    gcc --std=gnu99 -fPIC -shared alternate_simple_menu_extension_in_C.c \
 *          -o alternate_simple_menu_extension_in_C.so
 *
 * Add something like the following to
 * ${HOME}/.config/sortsmill-fontforge/user-init.scm:
 *
 * (let ((dll (dynamic-link
 *              "/full/path/to/alternate_simple_menu_extension_in_C.so")))
 *
 *   (register-fontforge-menu-entry
 *      #:window 'glyph
 *      #:menu-path '("Tools" "Useless tools"
 *                    "Glyph view alternate extension written in C")
 ...
 *   (register-fontforge-menu-entry
 *      #:window 'font
 *      #:menu-path '("Tools" "Font view alternate extension written in C")
 *      #:action (wrap-ff_menu_entry_action_t
 ...
 * http://www.gnu.org/software/libtool/manual/html_node/Using-libltdl.html
 */
#define glyph_menu_action alternate_simple_menu_extension_in_C_LTX_glyph_menu_action
#define glyph_menu_enabled alternate_simple_menu_extension_in_C_LTX_glyph_menu_enabled
#define font_menu_action alternate_simple_menu_extension_in_C_LTX_font_menu_action
