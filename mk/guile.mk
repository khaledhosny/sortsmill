...
GUILE_ENV = GUILE_AUTO_COMPILE=0																		\
	...
	LD_LIBRARY_PATH='$(abs_top_builddir)/guile:$(abs_top_builddir)/auxiliary:$(abs_top_builddir)/fontforge$(MY_LD_LIBRARY_PATH)'	\
	DYLD_LIBRARY_PATH='$(abs_top_builddir)/guile:$(abs_top_builddir)/auxiliary:$(abs_top_builddir)/fontforge$(MY_DYLD_LIBRARY_PATH)'
