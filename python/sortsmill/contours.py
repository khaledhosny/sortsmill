...
__make_contour_point             = guile.public_ref ('sortsmill fonts contours', 'make-contour-point')
__contour_point_x                = guile.public_ref ('sortsmill fonts contours', 'contour-point-x')
__contour_point_x_set_x          = guile.public_ref ('sortsmill fonts contours', 'contour-point-x-set!')
__contour_point_y                = guile.public_ref ('sortsmill fonts contours', 'contour-point-y')
__contour_point_y_set_x          = guile.public_ref ('sortsmill fonts contours', 'contour-point-y-set!')
__contour_point_on_curve_p       = guile.public_ref ('sortsmill fonts contours', 'contour-point-on-curve?')
__contour_point_on_curve_p_set_x = guile.public_ref ('sortsmill fonts contours', 'contour-point-on-curve?-set!')
__contour_point_selected_p       = guile.public_ref ('sortsmill fonts contours', 'contour-point-selected?')
__contour_point_selected_p_set_x = guile.public_ref ('sortsmill fonts contours', 'contour-point-selected?-set!')
__contour_point_name             = guile.public_ref ('sortsmill fonts contours', 'contour-point-name')
__contour_point_name_set_x       = guile.public_ref ('sortsmill fonts contours', 'contour-point-name-set!')

__make_contour                   = guile.public_ref ('sortsmill fonts contours', 'make-contour')
__contour_points                 = guile.public_ref ('sortsmill fonts contours', 'contour-points')
__contour_points_set_x           = guile.public_ref ('sortsmill fonts contours', 'contour-points-set!')
__contour_closed_p               = guile.public_ref ('sortsmill fonts contours', 'contour-closed?')
__contour_closed_p_set_x         = guile.public_ref ('sortsmill fonts contours', 'contour-closed?-set!')
__contour_degree                 = guile.public_ref ('sortsmill fonts contours', 'contour-degree')
__contour_degree_set_x           = guile.public_ref ('sortsmill fonts contours', 'contour-degree-set!')
__contour_name                   = guile.public_ref ('sortsmill fonts contours', 'contour-name')
__contour_name_set_x             = guile.public_ref ('sortsmill fonts contours', 'contour-name-set!')
